# Generated by Django 5.0.13 on 2025-03-07 12:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TblTransactions086',
            fields=[
                ('tst_transaction_id', models.AutoField(primary_key=True, serialize=False)),
                ('tst_amount', models.DecimalField(decimal_places=2, max_digits=15)),
                ('tst_transaction_type', models.CharField(blank=True, max_length=20, null=True)),
